...
namespace SistemaPymes
{
    public partial class frmRV : Form
    {
        ...
        private void frmRV_Load(object sender, EventArgs e)
        {
            // Cargar datos desde el archivo XML a un DataSet
            DataSet dt = new DataSet();
            dt.ReadXml("ReporteVentas.xml");
            ...
            {
                this.reportViewer.LocalReport.DataSources.Add(new ReportDataSource("dsRV", dt.Tables[0]));
            }
            else
            {
