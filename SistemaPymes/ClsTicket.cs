...
namespace SistemaPymes
{
    internal class ClsTicket
    {
        ...
        float leftMargin = 0;
        float topMargin = 3;
        string fontName = "Lucida Console"; //"courier condensed";
        int fontSize = 6;
        Font printFont = null;
        ...
        public void AddItem(string item, string cantidad, string price)
        {
    ...
    public class OrderItem
    {
        ...
        public string GenerateItem(string item, string cantidad, string price)
        {
            return item + delimitador[0] + cantidad + delimitador[0] + price;
        }
    }
