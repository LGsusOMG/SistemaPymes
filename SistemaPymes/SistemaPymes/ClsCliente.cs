...
namespace SistemaPymes
{
    ...
    class ClsCliente : ClsPersona
    {
        ...
        private int pu;  // puntos para el cliente
        ...
        public int puntos { get { return this.pu; } set { this.pu = value; } }
        ...
        {            
            ...
            MySqlCommand cmd = new MySqlCommand("Insert into clientes values(@co,@rf,@no,@di,@te,@em,@pu)",cn);
            cn.Open();
            ...
            cmd.Parameters.AddWithValue("@pu", this.pu);
        ...
        {
            MySqlConnection cn = new MySqlConnection(miclase.conexion);
            MySqlCommand cmd = new MySqlCommand("Delete from clientes Where codigo=@co", cn);
            cn.Open();
        ...
        {
            MySqlConnection cn = new MySqlConnection(miclase.conexion);
            MySqlCommand cmd = new MySqlCommand("Update clientes set rfc=@rf,nombre=@no,direccion=@di,telefono=@te,email=@em,puntos=@pu where codigo=@co", cn);
            cn.Open();
            cmd.Parameters.AddWithValue("@co", this.co);
            cmd.Parameters.AddWithValue("@rf", this.rf);
            cmd.Parameters.AddWithValue("@no", this.no);
