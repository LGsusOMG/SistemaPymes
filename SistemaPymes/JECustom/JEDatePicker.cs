...
{
    public class JEDatePicker : DateTimePicker
    {
        //Fields
        //-> Appearance
        ...
        private Image calendarIcon = SistemaPymes.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = SistemaPymes.Properties.Resources.calendarDark;
                else calendarIcon = SistemaPymes.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
